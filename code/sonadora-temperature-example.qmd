...
ggplot(data = sonadora_sum, 
       aes(x = elevation_m, # x-axis: elevation in m
           y = mean_temp_c)) + # y-axis: mean air emperature
...
temperature_model <- lm(
  ...
  data = sonadora_sum # sondadora data frame
  )
...
# diagnostics
par(mfrow = c(2, 2))
plot(temperature_model) # displays plot in 2x2 grid 
...
# creating temperature model table
